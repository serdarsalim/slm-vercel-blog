...
function BlogPostContent() {
  ...
  // Process HTML content, adding id's to h2 & h3 for TOC linking
...
>
  <div className="flex flex-wrap justify-center sm:justify-start gap-4">
    ...
    <Link href="/" className="group">
              <span className="flex items-center text-sm text-gray-500 dark:text-gray-400 mb-2 mr-20">
                <svg
                  className="w-4 h-4 mr-2"
                  fill="none"
                  stroke="currentColor"
    ...
    <a
      ...
      onClick={(e) => {
        e.preventDefault();
        // Include title and URL in the tweet
    ...
    <a
      ...
      onClick={(e) => {
        e.preventDefault();
        // LinkedIn needs URL and can take title/summary in some cases
        const postURL = typeof window !== "undefined" ? window.location.href : "";
        const linkedInUrl = `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(postURL)}&title=${encodeURIComponent(post.title)}`;
